...
def overloaded_lines(net: pandapowerNet, max_load: int = 100) -> pd.Index: ...
def violated_buses(net: pandapowerNet, min_vm_pu: float, max_vm_pu: float) -> pd.Index: ...
def nets_equal(
    net1: pandapowerNet,
    net2: pandapowerNet,
...
@overload
def get_element_index(net: pandapowerNet, element: str, name: str, exact_match: Literal[False]) -> pd.Index: ...
@overload
def get_element_index(net: pandapowerNet, element: str, name: str, exact_match: bool = True) -> int | pd.Index: ...
@overload
...
def false_elm_links(net: pandapowerNet, elm: str, col: str, target_elm: str | Iterable[str]) -> pd.Index: ...
def false_elm_links_loop(net: pandapowerNet, elms: Iterable[str] | None = None) -> dict[str, pd.Index]: ...
def read_from_net(
    net: pandapowerNet,
    element: str,
...
def group_element_index(net: pandapowerNet, index: int, element_type: str) -> pd.Index: ...
