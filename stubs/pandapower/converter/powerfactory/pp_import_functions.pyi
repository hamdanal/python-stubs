...
def add_additional_attributes(
    item, net, element, element_id, attr_list: Incomplete | None = ..., attr_dict: Incomplete | None = ...
) -> None: ...
...
def create_line_type(net, item, cable_in_air: bool = ...): ...
...
def get_pf_sgen_results(net, item, sg, is_unbalanced, element: str = ...) -> None: ...
...
def create_trafo(net, item, export_controller: bool = ..., tap_opt: str = ..., is_unbalanced: bool = ...): ...
def get_pf_trafo_results(net, item, tid, is_unbalanced) -> None: ...
def create_trafo3w(net, item, tap_opt: str = ...) -> None: ...
def propagate_bus_coords(net, bus1, bus2) -> None: ...
def create_coup(net, item, is_fuse: bool = ...) -> None: ...
