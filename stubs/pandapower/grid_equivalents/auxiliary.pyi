...
def add_ext_grids_to_boundaries(
    ...
    runpp_fct=...,
    calc_volt_angles: bool = ...,
    allow_net_change_for_convergence: bool = ...,
) -> None: ...
def drop_internal_branch_elements(net, internal_buses, branch_elements: Incomplete | None = ...) -> None: ...
def calc_zpbn_parameters(net, boundary_buses, all_external_buses, slack_as: str = ..., existing_shift_degree: bool = ...): ...
def check_validity_of_Ybus_eq(net_zpbn, Ybus_eq, bus_lookups): ...
def drop_assist_elms_by_creating_ext_net(net, elms: Incomplete | None = ...) -> None: ...
...
def ensure_origin_id(net, no_start: int = ..., elms: Incomplete | None = ...) -> None: ...
def drop_and_edit_cost_functions(net, buses, drop_cost, add_origin_id, check_unique_elms_name: bool = ...) -> None: ...
