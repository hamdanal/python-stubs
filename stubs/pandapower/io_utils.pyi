import json
from _typeshed import Incomplete, ReadableBuffer, Self, StrOrBytesPath, SupportsRead
...
class JSONSerializableClass:
    ...
    @classmethod
    def from_dict(cls: type[Self], d: dict[str, object]) -> Self: ...
    @classmethod
    def from_json(cls: type[Self], json_string: str | ReadableBuffer) -> Self: ...
