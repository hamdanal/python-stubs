...
_ErrorBar: TypeAlias = str | tuple[str, float] | Callable[[Iterable[float]], tuple[float, float]]  # noqa: PYI047
_Estimator: TypeAlias = str | Callable[..., Incomplete]  # noqa: PYI047
_Legend: TypeAlias = Literal["auto", "brief", "full"] | bool  # noqa: PYI047
_LogScale: TypeAlias = bool | float | tuple[bool | float, bool | float]  # noqa: PYI047
_Palette: TypeAlias = str | Sequence[ColorType] | dict[Incomplete, ColorType]  # noqa: PYI047
_Seed: TypeAlias = int | np.random.Generator | np.random.RandomState  # noqa: PYI047
