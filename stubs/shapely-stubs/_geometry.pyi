...
from shapely._typing import ArrayLike, ArrayLikeSeq, GeoArray, GeoT, OptGeoArrayLike, OptGeoArrayLikeSeq
...
@overload
def set_srid(geometry: None, srid: SupportsIndex, **kwargs) -> None: ...
@overload
def set_srid(geometry: GeoT, srid: SupportsIndex, **kwargs) -> GeoT: ...
@overload
...
@overload
def get_geometry(geometry: Geometry, index: SupportsIndex, **kwargs) -> BaseGeometry | None: ...
@overload
...
@overload
def set_precision(geometry: None, grid_size: float, mode: _PrecisionMode = "valid_output", **kwargs) -> None: ...
@overload
def set_precision(geometry: GeoT, grid_size: float, mode: _PrecisionMode = "valid_output", **kwargs) -> GeoT: ...
@overload
def set_precision(
...
@overload
def force_2d(geometry: GeoT, **kwargs) -> GeoT: ...
@overload
def force_2d(geometry: OptGeoArrayLikeSeq, **kwargs) -> GeoArray: ...
@overload
def force_3d(geometry: None, z: float = 0.0, **kwargs) -> None: ...
@overload
def force_3d(geometry: GeoT, z: float = 0.0, **kwargs) -> GeoT: ...
@overload
