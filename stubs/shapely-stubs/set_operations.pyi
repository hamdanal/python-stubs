...
from shapely._typing import GeoArray, OptGeoArrayLike, OptGeoArrayLikeSeq
...
@overload
def difference(a: BaseGeometry, b: BaseGeometry, grid_size: float | None = None, **kwargs) -> BaseGeometry: ...
@overload
def difference(a: None, b: BaseGeometry | None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
def difference(a: BaseGeometry | None, b: None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
...
@overload
def intersection(a: BaseGeometry, b: BaseGeometry, grid_size: float | None = None, **kwargs) -> BaseGeometry: ...
@overload
def intersection(a: None, b: BaseGeometry | None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
def intersection(a: BaseGeometry | None, b: None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
...
@overload
def symmetric_difference(a: BaseGeometry, b: BaseGeometry, grid_size: float | None = None, **kwargs) -> BaseGeometry: ...
@overload
def symmetric_difference(a: None, b: BaseGeometry | None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
def symmetric_difference(a: BaseGeometry | None, b: None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
...
@overload
def union(a: BaseGeometry, b: BaseGeometry, grid_size: float | None = None, **kwargs) -> BaseGeometry: ...
@overload
def union(a: None, b: BaseGeometry | None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
def union(a: BaseGeometry | None, b: None, grid_size: float | None = None, **kwargs) -> None: ...
@overload
