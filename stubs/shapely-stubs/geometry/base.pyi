...
class BaseGeometry(Geometry):
    ...
    @overload
    def difference(self, other: BaseGeometry, grid_size: float | None = None) -> BaseGeometry: ...
    @overload
    ...
    @overload
    def intersection(self, other: BaseGeometry, grid_size: float | None = None) -> BaseGeometry: ...
    @overload
    ...
    @overload
    def symmetric_difference(self, other: BaseGeometry, grid_size: float | None = None) -> BaseGeometry: ...
    @overload
    ...
    @overload
    def union(self, other: BaseGeometry, grid_size: float | None = None) -> BaseGeometry: ...
    @overload
