...
from shapely._typing import ArrayLike, ArrayLikeSeq, GeoArrayLikeSeq, OptGeoArrayLikeSeq
...
@overload
def has_z(geometry: BaseGeometry | None, **kwargs) -> bool: ...
@overload
def has_z(geometry: OptGeoArrayLikeSeq, **kwargs) -> NDArray[np.bool_]: ...
@overload
def is_ccw(geometry: BaseGeometry | None, **kwargs) -> bool: ...
@overload
def is_ccw(geometry: OptGeoArrayLikeSeq, **kwargs) -> NDArray[np.bool_]: ...
@overload
def is_closed(geometry: BaseGeometry | None, **kwargs) -> bool: ...
@overload
def is_closed(geometry: OptGeoArrayLikeSeq, **kwargs) -> NDArray[np.bool_]: ...
@overload
def is_empty(geometry: BaseGeometry | None, **kwargs) -> bool: ...
@overload
def is_empty(geometry: OptGeoArrayLikeSeq, **kwargs) -> NDArray[np.bool_]: ...
@overload
def is_geometry(geometry: BaseGeometry, **kwargs) -> Literal[True]: ...
@overload
...
@overload
def is_prepared(geometry: GeoArrayLikeSeq, **kwargs) -> NDArray[np.bool_]: ...
@overload
def is_valid_input(geometry: BaseGeometry | None, **kwargs) -> Literal[True]: ...
@overload
def is_valid_input(geometry: GeoArrayLikeSeq, **kwargs) -> NDArray[np.bool_]: ...  # type: ignore[overload-overlap]
@overload
...
def equals_exact(a, b, tolerance: ArrayLike[float] = 0.0, **kwargs): ...
def relate(a, b, **kwargs): ...
def relate_pattern(a, b, pattern, **kwargs): ...
def dwithin(a, b, distance: float, **kwargs): ...
def contains_xy(geom, x: ArrayLike[float], y: ArrayLike[float] | None = None, **kwargs): ...
def intersects_xy(geom, x: ArrayLike[float], y: ArrayLike[float] | None = None, **kwargs): ...
